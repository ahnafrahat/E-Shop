 ...
 * @author hello
 */
public class HomeDesignController implements Initializable {
    ...
    @FXML
    private void onOpenCartButtonTap(ActionEvent event) throws IOException {
    ...
    @FXML
    private void onRequestProductButtonTap(ActionEvent event) throws IOException {
        Parent RequestProductPage = FXMLLoader.load(getClass().getResource("RequestProduct.fxml"));

        Scene requestScene = new Scene(RequestProductPage);
        Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
...
//    }
    ...
    @FXML
    private void onAddToCartButtonTap(ActionEvent event) {
